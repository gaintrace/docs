...
**Can my organization use its own Google OAuth client?**
Yes, if you are on Google Workspace. See [Use your own Google OAuth client](/help/integrations/google-oauth-client).

## Related articles

<CardGroup cols={2}>
  <Card title="Google OAuth client" href="/help/integrations/google-oauth-client">
    Connect Gmail through a client your own organization owns.
  </Card>
